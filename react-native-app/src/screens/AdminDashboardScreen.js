            ...
            >
                ...
                <View style={styles.statsContainer}>
                    <View style={styles.statCard}>
                        <MaterialCommunityIcons name="calendar-multiple" size={32} color="#667eea" />
                    ...
                    <View style={styles.statCard}>
                        ...
                        <Text style={styles.statValue}>{stats?.totalPhotographers || 0}</Text>
                        <Text style={styles.statLabel}>Photographers</Text>
                    </View>
                    <View style={styles.statCard}>
                        <MaterialCommunityIcons name="image-multiple" size={32} color="#ff9800" />
                ...
                <View style={styles.section}>
                    ...
                    >
                        ...
                        <View style={styles.actionContent}>
                            ...
                            <Text style={styles.actionDescription}>Create and manage event schedules</Text>
                        </View>
                    ...
                    >
                        ...
                        <View style={styles.actionContent}>
                            <Text style={styles.actionTitle}>Manage Photographers</Text>
                            <Text style={styles.actionDescription}>Assign and monitor team members</Text>
                        </View>
                        <MaterialCommunityIcons name="chevron-right" size={24} color="#ccc" />
                    </TouchableOpacity>
                </View>
